...
class BoronganController with ChangeNotifier {
  ...
  //     for (int i = 0; i < data_borongan_list.length; i++) {
  //       Map<String, dynamic> isi_map = new Map<String, dynamic>();
  //       isi_map['a'] = data_borongan_list[i]['tanggal'];
  //       isi_map['b'] = data_borongan_list[i]['no_bukti'];
  //       isi_map['c'] = data_borongan_list[i]['sales'];
  //       isi_map['d'] = data_borongan_list[i]['customer'];
  //       isi_map['e'] = data_borongan_list[i]['keterangan'];
  //       isi_map['f'] = data_borongan_list[i]['total_qty'];
  //       isi_map['g'] = data_borongan_list[i]['total_so'];
  //       if (data_borongan_list[i]['status'] == 1) {
  //         isi_map['h'] = "Diterima";
  //       } else {
  ...
  //     map_transaksi['a'] = data_borongan_list[index_terpilih]['tanggal'];
  //     map_transaksi['b'] = data_borongan_list[index_terpilih]['no_bukti'];
  //     map_transaksi['c'] = data_borongan_list[index_terpilih]['sales'];
  //     map_transaksi['d'] = data_borongan_list[index_terpilih]['customer'];
  //     map_transaksi['e'] = data_borongan_list[index_terpilih]['keterangan'];
  //     if (data_borongan_list[index_terpilih]['status'] == 1) {
  ...
  //     footer_excel.add(data_borongan_list[index_terpilih]['total_qty']);
  //     footer_excel.add("Total");
  //     footer_excel.add(data_borongan_list[index_terpilih]['total_so']);
  //     String judul =
  //         "Invoice Order Penjualan (${data_borongan_list[index_terpilih]['no_bukti']})";
