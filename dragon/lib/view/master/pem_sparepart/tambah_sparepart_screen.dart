...
class _TambahSparepartScreenState extends State<TambahSparepartScreen> {
  ...
  void initState() {
    ...
    if (widget.isModeEdit) {
      m_sparepart.KD_BHNController.text = widget.data_sparepart['KD_BHN'] ?? "";
      m_sparepart.NA_BHNController.text = widget.data_sparepart['NA_BHN'] ?? "";
      m_sparepart.SATUANController.text =
          widget.data_sparepart['SATUAN'].toString() ?? "";
    } else {
