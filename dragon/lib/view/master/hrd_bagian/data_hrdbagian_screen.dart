...
import 'package:dragon/view/master/hrd_bagian/tambah_hrdbagian_screen.dart';
import 'package:dragon/view/master/hrd_bagian/hrdbagian_card.dart';
import 'package:provider/provider.dart';

class DataHRDbagianScreen extends StatefulWidget {
  @override
  _DataHRDbagianScreenState createState() => _DataHRDbagianScreenState();
}
...
class _DataHRDbagianScreenState extends State<DataHRDbagianScreen> {
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              TambahHRDbagianScreen(isModeEdit: false)));
                },
                child: Container(
                  height: 30,
                  child: Row(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              // ),
              Expanded(
                child: (hrdbagianController.data_hrdBagianList.length > 0)
                    ? ListView.builder(
                        itemCount:
                            hrdbagianController.data_hrdBagianList.length,
                        itemBuilder: (BuildContext context, int index) {
                          return HRDbagianCard(
                              context, index, hrdbagianController,
                              pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => TambahHRDbagianScreen(
                                        isModeEdit: true,
                                        data_hrdbagian: hrdbagianController
                            ...
                            showAnimatedDialog_withCallBack(
                              ...
                              if (value != null) {
                                if (value) {
                                  if (value) {
                                    hrdbagianController.hapus_hrdbagian(
                                        hrdbagianController
                                            .data_hrdBagianList[index]);
                                  ...
                                  hrdbagianController.notifyListeners();
                                }
                              }
                            });
                          });
        ...
        bottomNavigationBar: Container(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (hrdbagianController.data_hrdBagianList.length > 0)
                  Text(
                    (hrdbagianController.offset + 1 <
                            hrdbagianController.totalNotaTerima)
                        ? "Showing ${hrdbagianController.offset + 1} to ${hrdbagianController.offset + hrdbagianController.limit} of ${hrdbagianController.totalNotaTerima} entries"
                        : "Showing ${hrdbagianController.offset + 1} to ${hrdbagianController.totalNotaTerima} of ${hrdbagianController.totalNotaTerima} entries",
                    style: GoogleFonts.poppins(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                        color: Colors.black),
                      ...
                      child: Padding(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            value: hrdbagianController.limit,
                            items: hrdbagianController.dropdownLimit,
                            onChanged: (value) {
                              if (value != null) {
                ...
                InkWell(
                  onTap: () {
                    if (hrdbagianController.page_index > 0) {
                      hrdbagianController.offset -= hrdbagianController.limit;
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: (hrdbagianController.offset == 0)
                                ? GreyColor
                                : Colors.black),
                      ),
                    ),
                ...
                InkWell(
                  onTap: () {
                    if (hrdbagianController.page_index <=
                        hrdbagianController.pageCount - 1) {
                      hrdbagianController.offset += hrdbagianController.limit;
                      hrdbagianController.page_index++;
                      hrdbagianController.c_page.text =
                          (hrdbagianController.page_index + 1).toString();
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: ((hrdbagianController.pageCount -
                                        hrdbagianController.page_index) <=
                                    1)
                                ? GreyColor
                                : Colors.black),
  ...
  ///paginate
  Widget pageField() {
    HRD_BagianController pageTerima =
