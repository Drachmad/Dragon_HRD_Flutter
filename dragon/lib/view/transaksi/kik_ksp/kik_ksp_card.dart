...
Widget KikKspCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikKspController>(
      builder: (context, kik_kspController, child) {
    var data_so = kik_kspController.data_kik_ksp_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_kspController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_kspController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
