...
Widget AddKikKspCard(BuildContext context, int index, DataKIK data_kik) {
  ...
  var kik_kspController = Provider.of<KikKspController>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_kspController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_kspController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_kspController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_kspController.chooseDate;
                      kik_kspController.tglController.text = kik_kspController
                          .format_tanggal
                          .format(kik_kspController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_kspController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_kspController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_kspController.data_kik_keranjang[index].upah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_kspController.data_kik_keranjang[index].jumlah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_kspController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_kspController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_kspController.data_kik_keranjang.removeAt(index);
              kik_kspController.hitungSubTotal();
            },
            child: Padding(
