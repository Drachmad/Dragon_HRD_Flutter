...
Widget BoronganCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<BoronganController>(
      builder: (context, boronganController, child) {
    var data_so = boronganController.data_borongan_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          boronganController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == boronganController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
