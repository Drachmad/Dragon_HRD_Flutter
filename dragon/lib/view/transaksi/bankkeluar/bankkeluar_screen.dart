...
import 'package:dragon/view/transaksi/bankkeluar/add_bankkeluar_screen.dart';
import 'package:dragon/view/transaksi/bankkeluar/widget/bankkeluar_card.dart';
import 'package:provider/provider.dart';

import 'widget/filter_tanggal.dart';

class BankKeluarScreen extends StatefulWidget {
  @override
  _BankKeluarScreenState createState() => _BankKeluarScreenState();
}

class _BankKeluarScreenState extends State<BankKeluarScreen> {
  @override
  void initState() {
    Provider.of<BankkeluarController>(context, listen: false).initData();
    super.initState();
  }
          ...
          actions: [
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => AddBankKeluarScreen(false)))
                        .then((value) {
                      if (value != null) {
                        if (value) {
              ...
              child: InkWell(
                ...
                onTap: () {
                  showAnimatedDialog_withCallBack(context, ModeExport(1),
                    ...
                    if (value != null) {
                      if (value == 1) {
                        bankkeluarController.proses_export_detail();
                      } else if (value == 2) {
                        bankkeluarController.proses_export();
                      }
                    }
                  });
                },
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  if (bankkeluarController.index_terpilih != null) {
                    bankkeluarController.proses_print();
                  } else {
                    Toast(
                        "Peringatan",
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: TextField(
                                  controller:
                                      bankkeluarController.searchController,
              ...
              Expanded(
                child: (bankkeluarController.data_order_penjualan_list.length >
                        0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount: bankkeluarController
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return OrderPenjualanCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddBankKeluarScreen(
                                          true,
                                          data_edit: bankkeluarController
                              ...
                              if (value != null) {
                                if (value) {
                                  bankkeluarController
                                      .deleteBankkeluar(bankkeluarController
                                              .data_order_penjualan_list[index]
                                          ['NO_BUKTI'])
                                      .then((value) {
                                    if (value) {
