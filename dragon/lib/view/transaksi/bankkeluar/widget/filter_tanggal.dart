          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              bankkeluarController.filter_tanggalController,
                          onSelectionChanged:
                              bankkeluarController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (bankkeluarController.isEnable_button) {
                      bankkeluarController.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (bankkeluarController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
