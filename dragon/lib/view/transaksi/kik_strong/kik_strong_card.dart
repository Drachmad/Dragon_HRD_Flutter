...
Widget KikStrongCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikStrongController>(
      builder: (context, kik_strongController, child) {
    var data_so = kik_strongController.data_kik_strong_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_strongController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_strongController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
