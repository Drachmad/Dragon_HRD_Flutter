...
Widget AddKikStrongCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_strongController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_strongController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_strongController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_strongController.chooseDate;
                      kik_strongController.tglController.text =
                          kik_strongController.format_tanggal
                              .format(kik_strongController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_strongController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_strongController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_strongController.data_kik_keranjang[index].upah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_strongController.data_kik_keranjang[index].jumlah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_strongController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_strongController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_strongController.data_kik_keranjang.removeAt(index);
              kik_strongController.hitungSubTotal();
            },
            child: Padding(
