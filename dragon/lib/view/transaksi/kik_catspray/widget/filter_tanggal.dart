          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_catsprayController.filter_tanggalController,
                          onSelectionChanged:
                              kik_catsprayController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_catsprayController.isEnable_button) {
                      kik_catsprayController.selectDataPaginate(true, '');
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_catsprayController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
