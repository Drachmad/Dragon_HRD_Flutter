...
Widget KikCatSprayCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikCatSprayController>(
      builder: (context, kik_catsprayController, child) {
    var data_so = kik_catsprayController.data_kik_catspray_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_catsprayController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_catsprayController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
