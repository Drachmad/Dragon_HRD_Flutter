...
Widget AddKikCatSprayCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_catsprayController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_catsprayController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_catsprayController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_catsprayController.chooseDate;
                      kik_catsprayController.tglController.text =
                          kik_catsprayController.format_tanggal
                              .format(kik_catsprayController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_catsprayController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_catsprayController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_catsprayController.data_kik_keranjang[index].upah =
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      kik_catsprayController.data_kik_keranjang[index].jumlah =
                          config().convert_rupiah(jumlahController.text);
                      kik_catsprayController.hitungSubTotal();
                    },
                  ),
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_catsprayController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_catsprayController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_catsprayController.data_kik_keranjang.removeAt(index);
              kik_catsprayController.hitungSubTotal();
            },
            child: Padding(
