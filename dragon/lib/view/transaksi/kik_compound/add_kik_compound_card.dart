...
Widget AddKikCompoundCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_compoundController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_compoundController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_compoundController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_compoundController.chooseDate;
                      kik_compoundController.tglController.text =
                          kik_compoundController.format_tanggal
                              .format(kik_compoundController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_compoundController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_compoundController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_compoundController.data_kik_keranjang[index].upah =
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      kik_compoundController.data_kik_keranjang[index].jumlah =
                          config().convert_rupiah(jumlahController.text);
                      kik_compoundController.hitungSubTotal();
                    },
                  ),
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_compoundController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_compoundController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_compoundController.data_kik_keranjang.removeAt(index);
              kik_compoundController.hitungSubTotal();
            },
            child: Padding(
