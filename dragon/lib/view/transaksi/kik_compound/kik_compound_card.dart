...
Widget KikCompoundCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikCompoundController>(
      builder: (context, kik_compoundController, child) {
    var data_so = kik_compoundController.data_kik_compound_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_compoundController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_compoundController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
