...
Widget AddKikFlockingCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_flockingController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_flockingController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_flockingController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_flockingController.chooseDate;
                      kik_flockingController.tglController.text =
                          kik_flockingController.format_tanggal
                              .format(kik_flockingController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_flockingController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_flockingController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_flockingController.data_kik_keranjang[index].upah =
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      kik_flockingController.data_kik_keranjang[index].jumlah =
                          config().convert_rupiah(jumlahController.text);
                      kik_flockingController.hitungSubTotal();
                    },
                  ),
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_flockingController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_flockingController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_flockingController.data_kik_keranjang.removeAt(index);
              kik_flockingController.hitungSubTotal();
            },
            child: Padding(
