...
Widget KikDR2Card(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikDR2Controller>(
      builder: (context, kik_dr2Controller, child) {
    var data_so = kik_dr2Controller.data_kik_dr2_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_dr2Controller.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_dr2Controller.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
