          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_dr2Controller.filter_tanggalController,
                          onSelectionChanged:
                              kik_dr2Controller.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_dr2Controller.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_dr2Controller.isEnable_button)
                          ? HijauColor
                          : GreyColor,
