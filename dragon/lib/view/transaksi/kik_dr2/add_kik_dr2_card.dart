...
Widget AddKikDR2Card(BuildContext context, int index, DataKIK data_kik) {
  ...
  var kik_dr2Controller = Provider.of<KikDR2Controller>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_dr2Controller.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_dr2Controller.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_dr2Controller.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_dr2Controller.chooseDate;
                      kik_dr2Controller.tglController.text = kik_dr2Controller
                          .format_tanggal
                          .format(kik_dr2Controller.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_dr2Controller.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_dr2Controller.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_dr2Controller.data_kik_keranjang[index].upah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_dr2Controller.data_kik_keranjang[index].jumlah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_dr2Controller.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_dr2Controller.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_dr2Controller.data_kik_keranjang.removeAt(index);
              kik_dr2Controller.hitungSubTotal();
            },
            child: Padding(
