...
Widget KikJukiCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikJukiController>(
      builder: (context, kik_jukiController, child) {
    var data_so = kik_jukiController.data_kik_juki_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_jukiController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_jukiController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
