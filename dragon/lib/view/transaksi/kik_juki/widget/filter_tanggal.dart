          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_jukiController.filter_tanggalController,
                          onSelectionChanged:
                              kik_jukiController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_jukiController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_jukiController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
