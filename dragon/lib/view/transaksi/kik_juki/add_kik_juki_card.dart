...
Widget AddKikJukiCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_jukiController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_jukiController.chooseDate = await showDatePicker(
                              context: context,
                              initialDate: kik_jukiController.chooseDate ??
                                  DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_jukiController.chooseDate;
                      kik_jukiController.tglController.text = kik_jukiController
                          .format_tanggal
                          .format(kik_jukiController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_jukiController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_jukiController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_jukiController.data_kik_keranjang[index].upah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_jukiController.data_kik_keranjang[index].jumlah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_jukiController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_jukiController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_jukiController.data_kik_keranjang.removeAt(index);
              kik_jukiController.hitungSubTotal();
            },
            child: Padding(
