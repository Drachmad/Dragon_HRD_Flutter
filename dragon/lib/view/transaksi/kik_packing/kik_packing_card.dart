...
Widget KikPackingCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikPackingController>(
      builder: (context, kik_packingController, child) {
    var data_so = kik_packingController.data_kik_packing_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_packingController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_packingController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
