...
class HarianScreen extends StatefulWidget {
  @override
  _HarianScreenState createState() => _HarianScreenState();
}
...
class _HarianScreenState extends State<HarianScreen> {
  ...
  @override
  void initState() {
    Provider.of<HarianController>(context, listen: false).setProsess(true);
    Provider.of<HarianController>(context, listen: false).initData();
    super.initState();
  }
              ...
              child: InkWell(
                ...
                onTap: () {
                  showAnimatedDialog_withCallBack(context, ModeExport(1),
                    ...
                    if (value != null) {
                      if (value == 1) {
                        // harianController.proses_export_detail();
                      } else if (value == 2) {
                        // harianController.proses_export();
                      }
                    }
                  });
                },
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                height: 30,
                                child: TextField(
                                  controller: harianController.searchController,
                                  ...
                                  onChanged: (value) {
                                    harianController.setProsess(true);
                                    harianController.selectDataPaginate(
                                        true, value);
                                  },
                                ),
                              ),
              ...
              Expanded(
                child: (harianController.data_harian_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 8),
                        itemCount: harianController.data_harian_list.length,
                        itemBuilder: (BuildContext context, int index) {
                          return HarianCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddHarianScreen(
                                          true,
                                          data_edit: harianController
                                              .data_harian_list[index],
                                        ))).then((value) {
                              if (value != null) {
                                if (value) {
                                  harianController.selectDataPaginate(true, '');
                            ...
                            showAnimatedDialog_withCallBack(
                              ...
                              if (value != null) {
                                if (value) {
                                  harianController
                                      .deleteHarian(harianController
                                          .data_harian_list[index]['no_bukti'])
                                      .then((value) {
                                    if (value) {
        ...
        bottomNavigationBar: Container(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (harianController.data_harian_list.length > 0)
                  Text(
                    (harianController.offset + 1 <
                            harianController.totalNotaTerima)
                        ? "Showing ${harianController.offset + 1} to ${harianController.offset + harianController.limit} of ${harianController.totalNotaTerima} entries"
                        : "Showing ${harianController.offset + 1} to ${harianController.totalNotaTerima} of ${harianController.totalNotaTerima} entries",
                    style: GoogleFonts.poppins(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                        color: Colors.black),
                      ...
                      child: Padding(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            value: harianController.limit,
                            items: harianController.dropdownLimit,
                            onChanged: (value) {
                              if (value != null) {
                                harianController.limit = value;
                                harianController.selectDataPaginate(
                                    false, cari.text);
                              }
                            },
                ...
                InkWell(
                  onTap: () {
                    if (harianController.page_index > 0) {
                      harianController.offset -= harianController.limit;
                      harianController.page_index--;
                      harianController.c_page.text =
                          (harianController.page_index + 1).toString();
                      harianController.selectDataPaginate(false, cari.text);
                    }
                  },
                  child: Container(
                    height: 35,
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                            ...
                            color: (harianController.offset == 0)
                                ? GreyColor
                                : Colors.black),
                      ),
                    ),
                ...
                InkWell(
                  onTap: () {
                    if (harianController.page_index <=
                        harianController.pageCount - 1) {
                      harianController.offset += harianController.limit;
                      harianController.page_index++;
                      harianController.c_page.text =
                          (harianController.page_index + 1).toString();
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: ((harianController.pageCount -
                                        harianController.page_index) <=
                                    1)
                                ? GreyColor
                                : Colors.black),
