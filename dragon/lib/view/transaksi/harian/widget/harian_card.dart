...
Widget HarianCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<HarianController>(
      builder: (context, harianController, child) {
    var data_so = harianController.data_harian_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          harianController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == harianController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
