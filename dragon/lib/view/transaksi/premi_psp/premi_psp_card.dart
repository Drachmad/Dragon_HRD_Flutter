...
Widget PremiPSPCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<PremiPSPController>(
      builder: (context, premi_pspController, child) {
    var data_so = premi_pspController.data_premi_psp_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          premi_pspController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == premi_pspController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
