...
Widget KikAssemblingCard(int index,
  ...
  return Consumer<KikAssemblingController>(
    ...
    var data_so = kik_assemblingController.data_kik_assembling_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_assemblingController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_assemblingController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
