...
Widget AddKikAssemblingCard(BuildContext context, int index, DataKIK data_kik) {
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8),
                  child: TextFormField(
                    controller: kik_assemblingController.tglController ?? "",
                    ...
                    onTap: () async {
                      kik_assemblingController
                          .chooseDate = await showDatePicker(
                              context: context,
                              initialDate:
                                  kik_assemblingController.chooseDate ??
                                      DateTime.now(),
                              lastDate: DateTime(2050),
                              firstDate: DateTime(DateTime.now().year - 1)) ??
                          kik_assemblingController.chooseDate;
                      kik_assemblingController.tglController.text =
                          kik_assemblingController.format_tanggal
                              .format(kik_assemblingController.chooseDate);
                    },
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        kik_assemblingController.data_kik_keranjang[index].qty =
                            int.parse(qtyController.text.replaceAll(',', ''));
                        qtyController.value = TextEditingValue();
                        kik_assemblingController.hitungSubTotal();
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      kik_assemblingController.data_kik_keranjang[index].upah =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_assemblingController.data_kik_keranjang[index].org =
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (numb) {
                      if (numb.isNotEmpty) {
                        ...
                        kik_assemblingController.data_kik_keranjang[index].hr =
          ...
          InkWell(
            onTap: () {
              kik_assemblingController.data_kik_keranjang.removeAt(index);
              kik_assemblingController.hitungSubTotal();
            },
            child: Padding(
