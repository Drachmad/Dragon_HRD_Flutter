          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_assemblingController.filter_tanggalController,
                          onSelectionChanged:
                              kik_assemblingController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_assemblingController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_assemblingController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
