...
Widget KikMicroCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikMicroController>(
      builder: (context, kik_microController, child) {
    var data_so = kik_microController.data_kik_micro_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_microController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_microController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
