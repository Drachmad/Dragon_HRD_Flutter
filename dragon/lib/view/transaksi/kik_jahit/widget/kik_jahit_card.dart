...
Widget KikJahitCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikJahitController>(
      builder: (context, kik_jahitController, child) {
    var data_so = kik_jahitController.data_kik_jahit_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_jahitController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_jahitController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
