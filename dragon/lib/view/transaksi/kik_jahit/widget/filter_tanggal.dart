          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_jahitController.filter_tanggalController,
                          onSelectionChanged:
                              kik_jahitController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_jahitController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_jahitController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
