...
Widget KikPlongCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikPlongController>(
      builder: (context, kik_plongController, child) {
    var data_so = kik_plongController.data_kik_plong_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_plongController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_plongController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
