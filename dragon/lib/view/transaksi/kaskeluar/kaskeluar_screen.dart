...
import 'package:dragon/view/transaksi/kaskeluar/add_kaskeluar_screen.dart';
import 'package:dragon/view/transaksi/kaskeluar/widget/kaskeluar_card.dart';
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      if (value != null) {
                        if (value) {
                          kaskeluarController.select_data();
                        }
                      }
                    });
                  },
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: (kaskeluarController.data_order_penjualan_list.length >
                        0)
                    ? ListView.builder(
