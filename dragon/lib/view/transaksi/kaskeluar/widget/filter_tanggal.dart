          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kaskeluarController.filter_tanggalController,
                          onSelectionChanged:
                              kaskeluarController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kaskeluarController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kaskeluarController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
