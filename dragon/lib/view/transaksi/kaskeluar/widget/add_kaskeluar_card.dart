    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_account_keranjang[index].nacno =
                          nacnoController.text;
                      kaskeluarController.hitungSubTotal();
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_account_keranjang[index].reff =
                          reffController.text;
                      // kaskeluarController.hitungSubTotal();
                      kaskeluarController.notifyListeners();
                    }
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      kaskeluarController.data_account_keranjang[index].jumlah =
          ...
          InkWell(
            onTap: () {
              kaskeluarController.data_account_keranjang.removeAt(index);
              kaskeluarController.hitungSubTotal();
            },
            child: Padding(
