...
import 'package:dragon/view/transaksi/kaskeluar/pilih_account.dart';
import 'package:dragon/view/base_widget/save_success.dart';
import 'package:dragon/view/transaksi/kaskeluar/widget/add_kaskeluar_card.dart';
...
class AddKasKeluarScreen extends StatefulWidget {
  ...
  AddKasKeluarScreen(this.isModeEdit, {this.data_edit});

  @override
  _AddKasKeluarScreenState createState() => _AddKasKeluarScreenState();
}

class _AddKasKeluarScreenState extends State<AddKasKeluarScreen> {
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text(
                (widget.isModeEdit) ? "Edit Kas Keluar" : "Tambah Kas Keluar",
            ...
            children: [
                  ...
                  child: Container(
                    ...
                    child: searchTextField = AutoCompleteTextField<DataAccount>(
                      ...
                      itemSubmitted: (item) {
                        ...
                        kaskeluarController.addKeranjang(db_item);
                      },
                      submitOnSuggestionTap: true,
                      clearOnSubmit: false,
                      key: key,
                      suggestions: kaskeluarController.accountList,
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: kaskeluarController.data_account_keranjang.length,
                  itemBuilder: (BuildContext context, int index) {
                    return AddKasKeluarCard(context, index,
                        kaskeluarController.data_account_keranjang[index]);
                  },
                ),
              ),
            ],
                    ...
                    children: [
                      TextSpan(
                        text: config().format_rupiah(
                            kaskeluarController.sumTotal.toString()),
                        style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: Colors.black),
