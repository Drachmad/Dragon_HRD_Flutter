...
Widget KikInjectionCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikInjectionController>(
      builder: (context, kik_injectionController, child) {
    var data_so = kik_injectionController.data_kik_injection_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_injectionController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_injectionController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
