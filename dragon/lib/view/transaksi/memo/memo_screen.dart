...
import 'package:dragon/view/transaksi/memo/add_memo_screen.dart';
import 'package:dragon/view/transaksi/memo/widget/memo_card.dart';
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => AddMemoScreen(false)))
                        .then((value) {
                      if (value != null) {
                        if (value) {
                          memoController.select_data();
                        }
                      }
                    });
                  },
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                height: 30,
                                child: TextField(
                                  controller: memoController.searchController,
              ...
              Expanded(
                child: (memoController.data_order_penjualan_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount:
                            memoController.data_order_penjualan_list.length,
