          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: memoController.filter_tanggalController,
                          onSelectionChanged: memoController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (memoController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (memoController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
