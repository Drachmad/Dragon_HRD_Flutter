...
import 'package:dragon/view/transaksi/memo/pilih_account.dart';
import 'package:dragon/view/base_widget/save_success.dart';
import 'package:dragon/view/transaksi/memo/widget/add_memo_card.dart';
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: config()
                            .format_rupiah(memoController.sumTotal.toString()),
                        style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: Colors.black),
