...
import 'package:dragon/view/transaksi/bankmasuk/pilih_account.dart';
import 'package:dragon/view/base_widget/save_success.dart';
import 'package:dragon/view/transaksi/bankmasuk/widget/add_bankmasuk_card.dart';
...
class AddBankMasukScreen extends StatefulWidget {
  ...
  AddBankMasukScreen(this.isModeEdit, {this.data_edit});

  @override
  _AddBankMasukScreenState createState() => _AddBankMasukScreenState();
}

class _AddBankMasukScreenState extends State<AddBankMasukScreen> {
  GlobalKey<AutoCompleteTextFieldState<DataAccount>> key = new GlobalKey();
  AutoCompleteTextField searchTextField;

  _AddBankMasukScreenState();

  @override
  void initState() {
    if (widget.isModeEdit) {
      Provider.of<BankmasukController>(context, listen: false)
          .initData_editBankmasuk(widget.data_edit);
    } else {
      Provider.of<BankmasukController>(context, listen: false)
          .initData_addBankmasuk();
    }
    super.initState();
  }
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text(
                (widget.isModeEdit) ? "Edit Bank Masuk" : "Tambah Bank Masuk",
          ...
          actions: [
            OnHoverButton(
              child: InkWell(
                onTap: () {
                  if (widget.isModeEdit) {
                    bankmasukController.editBankmasuk().then((value) {
                      if (value != null) {
                        if (value) {
                    ...
                    bankmasukController.saveBankmasuk().then((value) {
                      if (value != null) {
                        if (value) {
                          showAnimatedDialog_withCallBack(
                              context,
                              SaveSuccess("Success !!",
                                  "Berhasil menyimpan Bank Masuk ...!!"),
                              isFlip: true, callback: (value) {
                            if (value != null) {
                              if (value) {
                                bankmasukController.initData_addBankmasuk();
            ...
            children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onTap: () async {
                                          bankmasukController.chooseDate =
                                          ...
                                          bankmasukController
                                              ...
                                              bankmasukController.format_tanggal
                                                  .format(bankmasukController
                                                      .chooseDate);
                                        },
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            bankmasukController.bnamaController,
                                        readOnly: true,
                                        decoration: InputDecoration(
                                          contentPadding: EdgeInsets.only(
                                              top: 18, bottom: 18),
                  ...
                  child: Container(
                    ...
                    child: searchTextField = AutoCompleteTextField<DataAccount>(
                      ...
                      itemSubmitted: (item) {
                        ...
                        bankmasukController.addKeranjang(db_item);
                      },
                      submitOnSuggestionTap: true,
                      clearOnSubmit: false,
                      key: key,
                      suggestions: bankmasukController.accountList,
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: bankmasukController.data_account_keranjang.length,
                  itemBuilder: (BuildContext context, int index) {
                    return AddBankMasukCard(context, index,
                    ...
                    children: [
                      TextSpan(
                        text: config().format_rupiah(
                            bankmasukController.sumTotal.toString()),
                        style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: Colors.black),
