...
Widget KikSablonCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KikSablonController>(
      builder: (context, kik_sablonController, child) {
    var data_so = kik_sablonController.data_kik_sablon_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          kik_sablonController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == kik_sablonController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
