          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              kik_sablonController.filter_tanggalController,
                          onSelectionChanged:
                              kik_sablonController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (kik_sablonController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (kik_sablonController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
