...
class model_bankkeluar {
  ...
  Future<List> countBankKeluar(String date) async {
  ...
  ///SELECT HEADER
  Future<List> select_bankkeluar(
      String cari, String start_date, String end_date) async {
    final response = await http.post(
      Uri.parse("${baseUrl}:3000/tampil_bank_keluar"),
  ...
  Future<List> select_bankkeluar_aktif(String cari, String sales,
  ...
  Future<List> delete_bankkeluar(String no_bukti) async {
    var konek = await m_koneksi.koneksi();
    var results1 =
