...
class model_kaskeluar {
  ...
  Future<List> countKasKeluar(String date) async {
  ...
  ///SELECT HEADER
  Future<List> select_kaskeluar(
      String cari, String start_date, String end_date) async {
    final response = await http.post(
      Uri.parse("${baseUrl}:3000/tampil_kas_keluar"),
  ...
  Future<List> select_kaskeluar_aktif(String cari, String sales,
  ...
  Future<List> delete_kaskeluar(String no_bukti) async {
    var konek = await m_koneksi.koneksi();
    var results1 =
